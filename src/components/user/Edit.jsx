		...
		<div className="container-fluid">
			<div className="row flex-nowrap">
				...
				<div className="col py-3">
					...
					<Input errors={errors} id ={"username"} title={"user name"} value={user.name} type={"text"} name={"name"} handleData={()=>handleData(event)} />
					<Input errors={errors} id ={"email"} title={"user email"} value={user.email} type={"email"} name={"email"} handleData={()=>handleData(event)} />
					<Input errors={errors} id ={"password"} title={"user password"} value={user.password} type={"password"} name={"password"} handleData={()=>handleData(event)}/>
