...
export default function Create() {
	...
	let [user, setUsers] = useState({name: '', email: '', password: ''})
		...
		<div className="container-fluid">
			<div className="row flex-nowrap">
				...
				<div className="col py-3">
					...
					<Input errors={errors} id ={"username"} title={"user name"}  type={"text"} name={"name"} handleData={()=>handleData(event)} />
					<Input errors={errors} id ={"email"} title={"user email"}  type={"email"} name={"email"} handleData={()=>handleData(event)} />
					<Input errors={errors} id ={"password"} title={"user password"}  type={"password"} name={"password"} handleData={()=>handleData(event)}/>
